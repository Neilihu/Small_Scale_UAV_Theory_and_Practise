...
class VehicleGeometry():
	...
	def getNewPoints(self, x, y, z, yaw, pitch, roll):
		...
		# rotation first then offset!!!!
		#get dcm from eluer
		r = Rotations.euler2DCM(yaw, pitch, roll)

		# new ned points = dcm * points   (A*B')' = B*A' 
		#rotation is Rvb not Rbv. That's why r without transpose
		newPoints = MatrixMath.multiply(newPoints, r)

		#add offset to the ned points from x,y,z
